...
<svelte:head>
	<title>Политика конфиденциальности - Truddy.ru | Как мы защищаем ваши данные</title>
	<meta
		name="description"
		content="Политика конфиденциальности Truddy.ru объясняет, как мы собираем, используем и защищаем вашу личную информацию. Узнайте о нашей приверженности безопасности данных, куки, сторонних сервисах и ваших правах на конфиденциальность."
	/>
	<link rel="canonical" href="https://truddy.ru/privacy/" />

	<!-- Open Graph -->
	<meta property="og:title" content="Политика конфиденциальности - Truddy.ru" />
	<meta property="og:description" content="Узнайте, как Truddy.ru защищает вашу конфиденциальность и личную информацию." />
	<meta property="og:type" content="website" />
	<meta property="og:url" content="https://truddy.ru/privacy/" />

	<!-- Twitter Card -->
	<meta name="twitter:card" content="summary" />
	<meta name="twitter:title" content="Политика конфиденциальности - Truddy.ru" />
				...
				<div class="bg-white rounded-lg shadow-sm border border-border p-6 lg:p-10">
					...
					<article id="introduction" class="mb-12 scroll-mt-6">
						...
						<div class="space-y-4 text-muted leading-relaxed">
							<p>
								В Truddy.ru мы стремимся уважать вашу конфиденциальность в интернете и признаём вашу потребность
							...
							<p>
								...
								вы можете посещать Truddy.ru, не сообщая нам, кто вы, и не раскрывая никакой Личной
								информации о себе.
							</p>
						</div>
					</article>
					...
					<article id="third-party" class="mb-12 scroll-mt-6">
						...
						<div class="space-y-4 text-muted leading-relaxed">
							<p>
								Третьи лица предоставляют определённые сервисы, доступные на Truddy.ru. Мы можем предоставлять
					...
					<article id="children" class="mb-12 scroll-mt-6">
						...
						<p class="text-muted leading-relaxed">
							Truddy.ru не будет связываться с детьми до 13 лет по поводу специальных предложений или
					...
					<article id="sharing" class="mb-12 scroll-mt-6">
						...
						<div class="bg-surface rounded-lg p-6 border border-border mb-6">
							<p class="font-semibold text-black mb-4">
								Truddy.ru не сдаёт в аренду, не продаёт и не передаёт личную информацию о вас другим
							...
							<ol class="space-y-3 text-muted list-decimal list-inside">
								<li>
									...
									Truddy.ru в рамках соглашений о конфиденциальности.
								</li>
								<li>
								...
								<li>
									Мы передаём информацию о вас, если Truddy.ru приобретается или сливается с другой
									компанией.
								</li>
							</ol>
						</div>
						<ul class="space-y-3 text-muted">
							<li class="flex items-start gap-3">
								...
								<span>Truddy.ru не предоставляет никакой личной информации рекламодателям, когда вы взаимодействуете
					...
					<article id="changes" class="mb-12 scroll-mt-6">
						...
						<div class="bg-warning-light rounded-lg p-6 border border-warning/20">
							<p class="text-muted leading-relaxed">
								Truddy.ru оставляет за собой право обновлять, изменять или модифицировать данную политику в любое время.
					...
					<article id="disclaimer" class="mb-12 scroll-mt-6">
						...
						<div class="bg-error-light rounded-lg p-6 border border-error/20">
							<div class="space-y-4 text-muted leading-relaxed">
								<p>
									Truddy.ru не хранит данные кредитных карт в месте, доступном через
								...
								<p class="font-semibold text-black">
									Truddy.ru не несёт ответственности за любые убытки или ущерб, причинённые в результате
					...
					<article id="contact" class="scroll-mt-6">
						...
						<div class="bg-surface rounded-lg p-6 border border-border">
							<p class="text-muted leading-relaxed mb-4">
								Truddy.ru приветствует ваши комментарии относительно данного заявления о конфиденциальности. Если у вас
							...
							<p class="text-sm text-muted mt-4">
								<strong>Примечание:</strong> Условия данного соглашения могут быть изменены Truddy.ru в любое время.
								Truddy.ru вправе предлагать свои услуги любому клиенту/потенциальному клиенту без ограничений.
							</p>
						</div>
					</article>
					...
					<div class="bg-primary/10 rounded-lg p-6 mt-10 border border-primary/20">
						...
						<p class="text-primary/80">
							Используя Truddy.ru, вы подтверждаете, что прочитали и поняли данную Политику конфиденциальности
