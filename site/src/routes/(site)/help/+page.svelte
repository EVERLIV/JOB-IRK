<script lang="ts">
	...
	const faqs: FaqItem[] = [
		// Getting Started
		{
			...
			question: 'Как создать аккаунт на Truddy.ru?',
		...
		},
		{
			id: 2,
			category: 'getting_started',
			question: 'Бесплатно ли Truddy.ru для соискателей?',
			answer: 'Да! Truddy.ru полностью бесплатен для соискателей. Вы можете создать аккаунт, искать вакансии, откликаться на неограниченное количество позиций и использовать все наши функции без каких-либо платежей.'
		},
		{
			id: 3,
			category: 'getting_started',
		...
		},
		{
			...
			answer: 'Проверьте папку со спамом на наличие писем от Truddy.ru. Добавьте support@truddy.ru в контакты. Также убедитесь, что email-уведомления включены в Настройки > Уведомления. Если проблема сохраняется, обратитесь в поддержку.'
		},
		{
			id: 21,
			category: 'technical',
...
<svelte:head>
	<title>Помощь - Truddy.ru | Найдите ответы на ваши вопросы</title>
	<meta name="description" content="Найдите ответы на частые вопросы об использовании Truddy.ru. Узнайте, как искать вакансии, создавать профиль, откликаться на позиции и многое другое." />
	<link rel="canonical" href="https://truddy.ru/help/" />
</svelte:head>
