...
<svelte:head>
	<title>Условия использования - Truddy.ru | Пользовательское соглашение и правила использования</title>
	<meta
		name="description"
		content="Ознакомьтесь с Условиями использования Truddy.ru, пользовательским соглашением и правилами использования. Понимайте свои права и обязанности при использовании нашей бесплатной платформы для поиска работы для соискателей и работодателей."
	/>
	<link rel="canonical" href="https://truddy.ru/terms/" />

	<!-- Open Graph -->
	<meta property="og:title" content="Условия использования - Truddy.ru" />
	<meta property="og:description" content="Пользовательское соглашение и условия использования платформы Truddy.ru." />
	<meta property="og:type" content="website" />
	<meta property="og:url" content="https://truddy.ru/terms/" />

	<!-- Twitter Card -->
	<meta name="twitter:card" content="summary" />
	<meta name="twitter:title" content="Условия использования - Truddy.ru" />
				...
				<div class="bg-white rounded-lg shadow-sm border border-border p-6 lg:p-10">
					...
					<article id="employer-eligibility" class="mb-12 scroll-mt-6">
						<div class="flex items-center gap-4 mb-6">
							...
							<h2 class="text-2xl font-semibold text-black">Допустимые подписчики Truddy.ru</h2>
						</div>
						<p class="text-muted leading-relaxed">
							Truddy.ru оставляет за собой право по своему усмотрению определять, соответствует ли фирма
							требованиям для подписки. Truddy.ru запрашивает информацию о социальных страницах компании
					...
					<article id="employer-conduct" class="mb-12 scroll-mt-6">
						...
						<div class="space-y-4 text-muted leading-relaxed">
							<p>
								...
								для того, чтобы позволить Работодателю использовать услуги, предлагаемые Truddy.ru. Работодатели, стремящиеся
							...
							<p>
								...
								или неприкосновенность частной жизни и законы о клевете. Работодатель настоящим предоставляет Truddy.ru
						...
						<div class="space-y-4">
							...
							<div class="bg-surface rounded-lg p-5 border border-border">
								...
								<p class="text-sm text-muted leading-relaxed">
									...
									напрямую через Truddy.ru или одного из наших авторизованных партнёров. Перепродажа Системы
									Truddy.ru или любого из её компонентов без предварительного письменного разрешения от Truddy.ru
					...
					<article id="user-conduct" class="mb-12 scroll-mt-6">
						...
						<p class="text-muted leading-relaxed">
							Вам должно быть не менее 18 лет, чтобы посещать или использовать Truddy.ru каким-либо образом. Посещая
							Truddy.ru или принимая данные Условия использования, Вы заявляете и гарантируете
							...
							заявляете и гарантируете Компании, что будете использовать Truddy.ru способом,
					...
					<article id="registration" class="mb-12 scroll-mt-6">
						...
						<p class="text-muted leading-relaxed">
							...
							учётной записи Truddy.ru и сервисов Truddy.ru. Вы соглашаетесь немедленно уведомить Компанию
							о любом несанкционированном использовании вашей Учётной записи и паролей. При регистрации на Truddy.ru
					...
					<article id="profile" class="mb-12 scroll-mt-6">
						...
						<div class="space-y-4 text-muted leading-relaxed">
							...
							<p>
								...
								точность любого резюме или материала, содержащегося в нём, размещённого Вами на Truddy.ru.
							</p>
							<p>
								Truddy.ru оставляет за собой право предлагать Вам сторонние услуги и продукты
								на основе предпочтений, которые Вы указываете при регистрации, и в любое время
								после неё, или на которые Вы согласились получать; такие предложения могут быть сделаны Truddy.ru
								или третьими лицами.
							</p>
							<p>
								Вы понимаете и подтверждаете, что не имеете никаких прав собственности на Вашу учётную запись и
								что если Вы отмените/прекратите свою учётную запись Truddy.ru, вся Ваша информация
								из Truddy.ru, включая резюме, Профили, сопроводительные письма, сохранённые вакансии, анкеты,
								...
								такого удаления через веб-серверы Truddy.ru. Кроме того, третьи лица могут сохранять
								копии Вашей Информации.
							</p>
							<p>
								Truddy.ru оставляет за собой право удалить Вашу учётную запись и всю Вашу Информацию
					...
					<article id="prohibited-users" class="mb-12 scroll-mt-6">
						...
						<div class="bg-error-light rounded-lg p-6 border border-error/20">
							<ul class="space-y-3 text-muted">
								...
								<li class="flex items-start gap-3">
									<div class="w-2 h-2 bg-error rounded-full mt-2 flex-shrink-0"></div>
									<span>Публиковать или отправлять на Truddy.ru неполную, ложную или неточную биографическую
								...
								<li class="flex items-start gap-3">
									...
									инфраструктуру Truddy.ru</span>
								</li>
								<li class="flex items-start gap-3">
									<div class="w-2 h-2 bg-error rounded-full mt-2 flex-shrink-0"></div>
									<span>Использовать сервисы Truddy.ru для незаконных целей или любой незаконной деятельности, или публиковать
					...
					<article id="revisions" class="mb-10 scroll-mt-6">
						...
						<p class="text-muted leading-relaxed">
							Truddy.ru может изменять данные Условия в любое время, публикуя обновлённую версию на
							https://www.truddy.ru. Вам следует периодически посещать эту страницу, чтобы ознакомиться с
						...
						<div class="flex items-start gap-4">
							...
							<div>
								...
								<p class="text-muted mb-4">
									По любым вопросам или юридическим опасениям, пожалуйста, напишите в службу поддержки Truddy.ru.
								</p>
								<a
									href="/contact/"
