    ...
    examples=[
        OpenApiExample(
            ...
            value={
                ...
                "comment": "I would like to know more about posting jobs on Truddy.ru.",
            },
            request_only=True,
        ),
        OpenApiExample(
...
def submit_contact_form(request):
    ...
    **Categories:**
    ...
    try:
        subject = f"New Contact Inquiry: {contact.get_enquery_type_display()} | Truddy.ru"
        support_emails = getattr(settings, 'SUPPORT_EMAILS', ['support@truddy.ru'])
        ...
        user_subject = "Thank you for contacting Truddy.ru"
